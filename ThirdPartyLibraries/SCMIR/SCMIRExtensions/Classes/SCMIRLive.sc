SCMIRLive { 
	...
	*newFromFile { | filename | ^super.new.load(filename); }
	...
	createSynthDef {| synthdefcalled, normalize = true, sendosc = true, controlbusses = true | 
		...
		def = SynthDef(synthdefname, { | in = 8, out = 0 |    
